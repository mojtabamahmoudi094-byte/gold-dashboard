export const darkTheme = {
  ...
  borderData:  'rgba(217,180,91,0.15)',
  text:        '#eef1f8',
  textBright:  '#FFFFFF',
  muted:       '#a9b0c2',
  faint:       '#3a4258',
...
export const lightTheme = {
  ...
  panelSolid:  '#FFFCF4',
  border:      'rgba(184,134,11,0.14)',
  borderStrong:'rgba(184,134,11,0.3)',
  borderData:  'rgba(184,134,11,0.14)',
  text:        '#1A1205',
  textBright:  '#0A0805',
  muted:       '#6B5A3A',
  faint:       '#A09070',
  ...
  cardShadow:  '0 2px 16px rgba(0,0,0,0.08), 0 1px 0 rgba(184,134,11,0.08)',
}
