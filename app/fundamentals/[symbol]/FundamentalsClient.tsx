...
import type { Fundamentals } from '../../../lib/fundamentalsData'
...
export default function FundamentalsPage({ symbol, initialData }: {
  symbol: string
  ...
  const [data, setData] = useState<Fundamentals | null | 'missing'>(initialData ?? null)
