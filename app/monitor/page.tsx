...
const CATS = [
  ...
  },
  {
    ...
    title: 'صندوق‌های طلا', desc: 'رصد لحظه‌ای صندوق‌های مبتنی بر طلا — ۱۲:۳۰ تا ۱۸:۰۰',
    color: 'oklch(0.82 0.15 70)',
  },
  {
    href: '/monitor/silver', ready: true,
    title: 'صندوق‌های نقره', desc: 'رصد لحظه‌ای صندوق‌های مبتنی بر نقره — ۱۲:۳۰ تا ۱۸:۰۰',
    color: 'oklch(0.84 0.03 240)',
  },
  {
    href: '/monitor/saffron', ready: true,
    title: 'صندوق‌های زعفران', desc: 'رصد لحظه‌ای صندوق‌های کالایی زعفران — ۱۲:۳۰ تا ۱۸:۰۰',
