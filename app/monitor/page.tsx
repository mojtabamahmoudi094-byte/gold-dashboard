...
const CATS = [
  ...
  },
  {
    ...
    title: 'صندوق‌های نقره', desc: 'رصد لحظه‌ای صندوق‌های مبتنی بر نقره — ۱۲:۰۰ تا ۱۸:۰۰',
    color: 'oklch(0.84 0.03 240)',
  },
  {
    href: '/monitor/saffron', ready: true,
    title: 'صندوق‌های زعفران', desc: 'رصد لحظه‌ای صندوق‌های کالایی زعفران — ۱۲:۰۰ تا ۱۸:۰۰',
