...
echo ""
echo "ℹ️  خروجی علاوه بر public/fund-weights/ در FUND_WEIGHTS_DIR (پیش‌فرض"
echo "   /opt/bourssanj-site/data/fund-weights) هم نوشته می‌شود؛ روت /api/fund-weights"
echo "   از همان‌جا می‌خواند، پس دیپلوی بعدی (rsync --delete) آن را پاک نمی‌کند."
